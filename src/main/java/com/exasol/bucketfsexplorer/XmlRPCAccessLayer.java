...
public class XmlRPCAccessLayer {
	...
	public XmlRPCAccessLayer(Configuration exaoperationConfig) throws MalformedURLException {
	    ...
	    client.setTypeFactory(new XmlRpcTypeNil(client)); // accept nil type from EXASOL XMLRPC python server   
	}
	...
	public HashMap<String, Object> getPropertiesBucket(String bucketFSname, String bucket) throws XmlRpcException, MalformedURLException {
	    ...
	    myClient.setTypeFactory(new XmlRpcTypeNil(myClient)); // accept nil type from EXASOL XMLRPC python server   
	...
	public void addBucket (String bucketFS, String bucketName, String description, boolean publicBucket, String readPassword, String writePassword ) throws XmlRpcException  {
		Map<String, Comparable> map = new HashMap<String, Comparable>();
