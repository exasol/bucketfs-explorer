...
public class BucketFSAccessLayer {
    ...
    public static void uploadFileToBucketFS(String url, String filePath, String password) throws ClientProtocolException, IOException, URISyntaxException {
    ...
    public static void deleteFileInBucketFS(String url, String password) throws ClientProtocolException, IOException, URISyntaxException {
    ...
    @SuppressWarnings("deprecation")
	public static List<String> listFiles(String url, String password) throws ClientProtocolException, IOException, URISyntaxException, NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
